...
export type DistrictScope = "RAJASTHAN_EXCEPT_JAIPUR"|"JAIPUR_ONLY"|"SELECTED_DISTRICTS";
export interface BankRate extends RateBase { bank_id: number|null; bank_name: string|null; company_id:number|null; company_name:string|null; district_id:number|null; district_name:string|null; district_scope:DistrictScope|null; state: string | null }
...
export interface RatePayload {
  ...
  company_id?:number|null; district_id?:number|null; district_scope?:DistrictScope|null;
...
export interface BankRateBulkPayload extends Omit<RatePayload,"bank_id"|"executive_id"|"district_id"> { company_id:number; bank_ids:number[]|null; district_ids:number[]|null; district_scope:DistrictScope }
